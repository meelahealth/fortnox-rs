...
pub struct VacationDebtBasis {
    #[serde(rename = "Year")]
    pub year: i32,
    #[serde(rename = "Month")]
    pub month: i32,
    #[serde(rename = "LastDay", skip_serializing_if = "Option::is_none")]
    ...
    pub employees: Option<Vec<crate::http::models::VacationDebtBasisEmployee>>,
}

impl VacationDebtBasis {
    pub fn new(year: i32, month: i32) -> VacationDebtBasis {
        VacationDebtBasis {
            year,
            month,
            last_day: None,
