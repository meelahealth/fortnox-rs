...
pub struct Order {
    ...
    pub email_information: Option<Box<crate::http::models::OrderEmailInformation>>,
    #[serde(
    ...
    pub labels: Option<Vec<crate::http::models::OrderLabel>>,
    ...
    #[serde(rename = "OrderRows", skip_serializing_if = "Option::is_none")]
    pub order_rows: Option<Vec<crate::http::models::OrderOrderRow>>,
