...
pub struct Offer {
    ...
    #[serde(rename = "CopyRemarks", skip_serializing_if = "Option::is_none")]
    pub copy_remarks: Option<bool>,
    ...
    pub email_information: Option<Box<crate::http::models::OfferEmailInformation>>,
    ...
    #[serde(rename = "InvoiceReference", skip_serializing_if = "Option::is_none")]
    pub invoice_reference: Option<String>,
    #[serde(rename = "Labels", skip_serializing_if = "Option::is_none")]
    pub labels: Option<Vec<crate::http::models::OfferLabel>>,
    ...
    #[serde(rename = "OfferRows", skip_serializing_if = "Option::is_none")]
    pub offer_rows: Option<Vec<crate::http::models::OfferOfferRow>>,
    ...
    #[serde(
        rename = "YourReferenceNumber",
        skip_serializing_if = "Option::is_none"
    )]
    pub your_reference_number: Option<String>,
...
impl Offer {
    pub fn new(customer_number: String) -> Offer {
        Offer {
            at_url: None,
