...
pub struct InvoiceAccrual {
    ...
    pub invoice_accrual_rows: Vec<crate::http::models::InvoiceAccrualInvoiceAccrualRow>,
...
impl InvoiceAccrual {
    pub fn new(
        ...
        description: String,
        end_date: String,
        invoice_accrual_rows: Vec<crate::http::models::InvoiceAccrualInvoiceAccrualRow>,
        invoice_number: i32,
        revenue_account: i32,
        start_date: String,
        total: f64,
