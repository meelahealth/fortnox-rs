...
pub struct VoucherFileConnection {
    #[serde(rename = "@url", skip_serializing_if = "Option::is_none")]
    pub at_url: Option<String>,
    #[serde(rename = "FileId")]
    pub file_id: String,
    #[serde(rename = "VoucherDescription", skip_serializing_if = "Option::is_none")]
    pub voucher_description: Option<String>,
