...
pub struct InvoiceAccrualInvoiceAccrualRow {
...
impl InvoiceAccrualInvoiceAccrualRow {
    pub fn new() -> InvoiceAccrualInvoiceAccrualRow {
        InvoiceAccrualInvoiceAccrualRow {
            account: None,
            cost_center: None,
            credit: None,
            debit: None,
