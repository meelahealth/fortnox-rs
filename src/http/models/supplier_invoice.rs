...
pub struct SupplierInvoice {
    ...
    pub supplier_invoice_rows: Option<Vec<crate::http::models::SupplierInvoiceSupplierInvoiceRow>>,
    ...
    pub vouchers: Option<Vec<crate::http::models::SupplierInvoiceVoucher>>,
