...
pub struct InvoicePayload {
    ...
    pub edi_information: Option<Box<crate::http::models::InvoicePayloadEdiInformation>>,
    #[serde(rename = "EmailInformation", skip_serializing_if = "Option::is_none")]
    pub email_information: Option<Box<crate::http::models::InvoicePayloadEmailInformation>>,
    ...
    pub invoice_rows: Option<Vec<crate::http::models::InvoicePayloadInvoiceRow>>,
    #[serde(rename = "InvoiceType", skip_serializing_if = "Option::is_none")]
    pub invoice_type: Option<InvoiceType>,
    #[serde(rename = "Labels", skip_serializing_if = "Option::is_none")]
    pub labels: Option<Vec<crate::http::models::InvoicePayloadLabel>>,
