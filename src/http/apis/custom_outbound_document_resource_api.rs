...
pub struct SaveParams {
    ...
    pub document: Option<crate::http::models::CustomOutboundDocument>,
}
...
pub async fn get(
    ...
    let local_var_uri_str = format!("{}/api/warehouse/documentdeliveries/custom/outbound-v1/{type}/{id}", local_var_configuration.base_path, type=crate::http::apis::urlencode(r#type), id=crate::http::apis::urlencode(id));
...
pub async fn release(
    ...
    let local_var_uri_str = format!("{}/api/warehouse/documentdeliveries/custom/outbound-v1/{type}/{id}/release", local_var_configuration.base_path, type=crate::http::apis::urlencode(r#type), id=crate::http::apis::urlencode(id));
    let mut local_var_req_builder =
...
pub async fn void_document(
    ...
    let local_var_uri_str = format!("{}/api/warehouse/documentdeliveries/custom/outbound-v1/{type}/{id}/void", local_var_configuration.base_path, type=crate::http::apis::urlencode(r#type), id=crate::http::apis::urlencode(id));
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
