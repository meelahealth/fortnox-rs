...
pub struct BatchUpdateResponseStateParams {
    ...
    pub response_state_change: Option<crate::http::models::ResponseStateChange>,
}
...
pub struct CreatePurchaseOrderResourceParams {
    ...
    pub purchase_order: Option<crate::http::models::PurchaseOrder>,
}
...
pub struct SendPurchaseOrderParams {
    ...
    pub settings: Option<crate::http::models::PurchaseOrderMailSettings>,
}
