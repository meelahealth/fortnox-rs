...
pub struct Offer {
    ...
    pub email_information: Option<Box<crate::models::OfferEmailInformation>>,
    ...
    pub labels: Option<Vec<crate::models::OfferLabel>>,
    ...
    pub offer_rows: Option<Vec<crate::models::OfferOfferRow>>,
