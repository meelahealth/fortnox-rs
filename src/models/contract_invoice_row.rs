...
pub struct ContractInvoiceRow {
    ...
    pub house_work_type: Option<String>,
...
impl ContractInvoiceRow {
    pub fn new(article_number: String, delivered_quantity: String) -> ContractInvoiceRow {
        ContractInvoiceRow {
            account_number: None,
            article_number,
