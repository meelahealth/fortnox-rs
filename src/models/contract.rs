...
pub struct Contract {
    ...
    pub email_information: Option<Box<crate::models::ContractEmailInformation>>,
    #[serde(
    ...
    pub invoice_rows: Vec<crate::models::ContractInvoiceRow>,
...
impl Contract {
    pub fn new(
        ...
        invoice_rows: Vec<crate::models::ContractInvoiceRow>,
        period_end: String,
    ) -> Contract {
        Contract {
            at_url: None,
