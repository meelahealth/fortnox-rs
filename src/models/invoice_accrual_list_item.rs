...
pub struct InvoiceAccrualListItem {
...
impl InvoiceAccrualListItem {
    pub fn new(description: String, invoice_number: i32) -> InvoiceAccrualListItem {
        InvoiceAccrualListItem {
            at_url: None,
            description,
            invoice_number,
            period: None,
