...
pub struct Order {
    ...
    pub email_information: Option<Box<crate::models::OrderEmailInformation>>,
    #[serde(
    ...
    pub labels: Option<Vec<crate::models::OrderLabel>>,
    ...
    pub order_rows: Option<Vec<crate::models::OrderOrderRow>>,
