...
pub struct SalaryTransactionListItem {
    ...
    #[serde(rename = "SalaryRow", skip_serializing_if = "Option::is_none")]
    pub salary_row: Option<i32>,
    #[serde(rename = "Date")]
    pub date: String,
    ...
    #[serde(rename = "TextRow", skip_serializing_if = "Option::is_none")]
    pub text_row: Option<String>,
...
impl SalaryTransactionListItem {
    pub fn new(
        employee_id: String,
        salary_code: String,
        date: String,
    ) -> SalaryTransactionListItem {
        SalaryTransactionListItem {
            at_url: None,
            employee_id,
            salary_code,
