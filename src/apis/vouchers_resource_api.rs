...
pub struct CreateVouchersResourceParams {
    ...
    /// voucher to create
    pub voucher: Option<crate::models::VoucherWrap>,
}
...
) -> Result<crate::models::VoucherWrap, Error<CreateVouchersResourceError>> {
...
pub async fn get_vouchers_resource(
...
) -> Result<crate::models::VoucherWrap, Error<GetVouchersResourceError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        VoucherSeries = crate::apis::urlencode(voucher_series),
...
) -> Result<crate::models::VoucherListItemList, Error<ListSeriesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::VoucherListItemList, Error<ListVouchersResourceError>> {
    let local_var_configuration = configuration;
