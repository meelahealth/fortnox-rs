...
pub struct CreateProjectsResourceParams {
    /// to create
    pub project: Option<crate::models::ProjectWrap>,
}
...
) -> Result<crate::models::ProjectWrap, Error<CreateProjectsResourceError>> {
...
) -> Result<crate::models::ProjectWrap, Error<GetProjectsResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn list_projects_resource(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ProjectListItemList, Error<ListProjectsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ProjectWrap, Error<UpdateProjectsResourceError>> {
    let local_var_configuration = configuration;
