...
pub struct CreateArticlesResourceArticlesParams {
    /// to create
    pub article: Option<crate::models::ArticleWrap>,
}
...
) -> Result<crate::models::ArticleWrap, Error<CreateArticlesResourceArticlesError>> {
...
) -> Result<crate::models::ArticleWrap, Error<GetArticlesResourceArticlesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ArticleListItemList, Error<ListArticlesResourceArticlesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ArticleWrap, Error<UpdateArticlesResourceArticlesError>> {
    let local_var_configuration = configuration;
