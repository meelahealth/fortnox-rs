...
pub struct CreateOrdersResourceParams {
    /// order to create
    pub order: Option<crate::models::OrderWrap>,
}
...
) -> Result<crate::models::OrderWrap, Error<CancelOrdersResourceError>> {
...
) -> Result<crate::models::OrderWrap, Error<CreateOrdersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::InvoiceWrap, Error<CreateinvoiceOrdersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OrderWrap, Error<EmailOrdersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OrderWrap, Error<ExternalprintOrdersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OrderWrap, Error<GetOrdersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OrderListItemList, Error<ListOrdersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OrderWrap, Error<UpdateOrdersResourceError>> {
    let local_var_configuration = configuration;
