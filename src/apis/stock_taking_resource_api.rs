...
pub struct CreateStockTakingResourceParams {
    /// stock taking
    pub stock_taking: Option<crate::models::StockTaking>,
}
...
) -> Result<crate::models::StockTaking, Error<CreateStockTakingResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_stock_taking_row(
    ...
    let row_id = crate::apis::urlencode(row_id);
    let local_var_uri_str = format!(
...
) -> Result<Vec<crate::models::StockTaking>, Error<GetAllStockTakingResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::StockTakingRow>, Error<GetCandidateRowsError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::StockTakingRow>, Error<GetRowsError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::StockTaking, Error<GetStockTakingResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::StockTaking, Error<UpdateStockTakingResourceError>> {
    let local_var_configuration = configuration;
