...
pub struct CreateCustomerReferencesResourceParams {
    ...
    pub customer_reference_row: Option<crate::models::CustomerReferenceCustomerReferenceRowWrap>,
}
...
) -> Result<crate::models::CustomerReferenceWrap, Error<CreateCustomerReferencesResourceError>> {
...
pub async fn get_customer_references_resource(
...
) -> Result<crate::models::CustomerReferenceWrap, Error<GetCustomerReferencesResourceError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        CustomerReferenceRowId = crate::apis::urlencode(customer_reference_row_id)
    );
    let mut local_var_req_builder =
...
) -> Result<crate::models::CustomerReferenceWrap, Error<ListCustomerReferencesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::CustomerWrap, Error<UpdateCustomerReferencesResourceError>> {
    let local_var_configuration = configuration;
