...
/// struct for passing parameters to the method [`get_file_by_id_inbox_resource`]
#[derive(Clone, Debug, Default)]
pub struct GetFileByIdInboxResourceParams {
    /// identifies the folder
    pub id: String,
}

/// struct for passing parameters to the method [`remove_inbox_resource`]
#[derive(Clone, Debug, Default)]
pub struct RemoveInboxResourceParams {
...
/// struct for typed errors of method [`get_file_by_id_inbox_resource`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetFileByIdInboxResourceError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_inbox_resource`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetInboxResourceError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`remove_inbox_resource`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RemoveInboxResourceError {
    DefaultResponse(),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_file_by_id_inbox_resource(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFileByIdInboxResourceError> =
...
pub async fn get_inbox_resource(
    configuration: &configuration::Configuration,
) -> Result<crate::models::FolderWrap, Error<GetInboxResourceError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/3/inbox/", local_var_configuration.base_path);
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetInboxResourceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_inbox_resource(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveInboxResourceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload(
    configuration: &configuration::Configuration,
    params: UploadParams,
) -> Result<crate::models::FolderFileRowWrap, Error<UploadError>> {
    let local_var_configuration = configuration;
