...
pub struct CreateIncomingGoodsResourceParams {
    ...
    pub incoming_goods: Option<crate::models::IncomingGoods>,
}
...
) -> Result<crate::models::IncomingGoods, Error<CreateIncomingGoodsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<Vec<crate::models::IncomingGoodsListRow>, Error<GetAllIncomingGoodsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::IncomingGoods, Error<GetIncomingGoodsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::IncomingGoods, Error<SaveIncomingGoodsResourceError>> {
    let local_var_configuration = configuration;
