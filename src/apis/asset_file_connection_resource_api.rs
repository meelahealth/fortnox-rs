...
pub struct CreateAssetFileConnectionResourceParams {
    ...
    pub asset_file_connection: Option<crate::models::CreateAssetFileConnection>,
}
...
) -> Result<crate::models::AssetFileConnection, Error<CreateAssetFileConnectionResourceError>> {
...
pub async fn get_all_asset_file_connection_resource(
    configuration: &configuration::Configuration,
) -> Result<crate::models::AssetFileConnectionResponse, Error<GetAllAssetFileConnectionResourceError>>
{
    let local_var_configuration = configuration;
