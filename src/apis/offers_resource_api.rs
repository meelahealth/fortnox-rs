...
pub struct CreateOffersResourceParams {
    /// to create
    pub offer: Option<crate::models::OfferWrap>,
}
...
) -> Result<crate::models::OfferWrap, Error<CancelOffersResourceError>> {
...
) -> Result<crate::models::OfferWrap, Error<CreateOffersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OrderWrap, Error<CreateorderError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OfferWrap, Error<EmailOffersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OfferWrap, Error<ExternalprintError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OfferWrap, Error<GetOffersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OfferListItemList, Error<ListOffersResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::OfferWrap, Error<UpdateOffersResourceError>> {
    let local_var_configuration = configuration;
