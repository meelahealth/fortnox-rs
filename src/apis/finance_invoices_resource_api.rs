...
pub struct CreateFinanceInvoicesResourceParams {
    ...
    pub payload: Option<crate::models::CreatePayloadWrap>,
}
...
pub struct PauseParams {
    ...
    pub number: String,
    /// The payload for sending an invoice with  Fortnox Finans
    pub payload: Option<crate::models::PausePayloadWrap>,
}
...
pub struct ReportPaymentParams {
    ...
    pub number: String,
    /// The payload for sending an invoice with  Fortnox Finans
    pub payload: Option<crate::models::ReportPaymentPayload>,
}
...
) -> Result<crate::models::InvoiceResponseWrap, Error<CreateFinanceInvoicesResourceError>> {
...
) -> Result<crate::models::InvoiceResponseWrap, Error<GetFinanceInvoicesResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn pause(
    configuration: &configuration::Configuration,
    params: PauseParams,
) -> Result<crate::models::InvoiceResponseWrap, Error<PauseError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::InvoiceResponseWrap, Error<ReportPaymentError>> {
    let local_var_configuration = configuration;
...
pub async fn stop(
    configuration: &configuration::Configuration,
    params: StopParams,
) -> Result<crate::models::InvoiceResponseWrap, Error<StopError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::InvoiceResponseWrap, Error<TakeFeesError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::InvoiceResponseWrap, Error<UnpauseError>> {
    let local_var_configuration = configuration;
