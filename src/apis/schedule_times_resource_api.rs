...
pub struct UpdateScheduleTimesResourceParams {
    ...
    pub date: String,
    /// to update
    pub schedule_time: Option<crate::models::ScheduleTimeWrap>,
}
...
) -> Result<crate::models::ScheduleTimeWrap, Error<GetScheduleTimesResourceError>> {
...
pub async fn reset(
    configuration: &configuration::Configuration,
    params: ResetParams,
) -> Result<crate::models::ScheduleTimeWrap, Error<ResetError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ScheduleTimeWrap, Error<UpdateScheduleTimesResourceError>> {
    let local_var_configuration = configuration;
