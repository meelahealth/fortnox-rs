...
pub struct CreateContractTemplatesResourceParams {
    ...
    pub contract_template: Option<crate::models::ContractTemplateWrap>,
}
...
) -> Result<crate::models::ContractTemplateWrap, Error<CreateContractTemplatesResourceError>> {
...
) -> Result<crate::models::ContractTemplateWrap, Error<GetContractTemplatesResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn list_contract_templates_resource(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ContractTemplateListItemList, Error<ListContractTemplatesResourceError>>
{
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ContractTemplateWrap, Error<UpdateContractTemplatesResourceError>> {
    let local_var_configuration = configuration;
