...
pub struct CreateEmployeesResourceParams {
    /// employee to create
    pub employee: Option<crate::models::EmployeeWrap>,
}
...
) -> Result<crate::models::EmployeeWrap, Error<CreateEmployeesResourceError>> {
...
) -> Result<crate::models::EmployeeWrap, Error<GetEmployeesResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn list_employees_resource(
    configuration: &configuration::Configuration,
) -> Result<crate::models::EmployeeListItemWrap, Error<ListEmployeesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::EmployeeWrap, Error<UpdateEmployeesResourceError>> {
    let local_var_configuration = configuration;
