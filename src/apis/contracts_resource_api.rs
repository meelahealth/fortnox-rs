...
pub struct CreateContractsResourceParams {
    /// contract to create
    pub contract: Option<crate::models::ContractWrap>,
}
...
) -> Result<crate::models::ContractWrap, Error<CreateContractsResourceError>> {
...
) -> Result<crate::models::InvoiceWrap, Error<CreateinvoiceError>> {
    let local_var_configuration = configuration;
...
pub async fn finish(
    configuration: &configuration::Configuration,
    params: FinishParams,
) -> Result<crate::models::ContractWrap, Error<FinishError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ContractWrap, Error<GetContractsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ContractWrap, Error<IncreaseinvoicecountError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ContractListItemList, Error<ListContractsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::ContractWrap, Error<UpdateContractsResourceError>> {
    let local_var_configuration = configuration;
