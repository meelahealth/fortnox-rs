...
pub struct CreateTaxReductionsResourceParams {
    /// to create
    pub tax_reduction: Option<crate::models::TaxReductionWrap>,
}
...
) -> Result<crate::models::TaxReductionWrap, Error<CreateTaxReductionsResourceError>> {
...
) -> Result<crate::models::TaxReductionWrap, Error<GetTaxReductionsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::TaxReductionListItemList, Error<ListTaxReductionsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::TaxReductionWrap, Error<UpdateTaxReductionsResourceError>> {
    let local_var_configuration = configuration;
