...
pub struct SaveCustomInboundDocumentResourceParams {
    ...
    pub document: Option<crate::models::CustomInboundDocument>,
}
...
pub async fn get_custom_inbound_document_resource(
...
) -> Result<crate::models::CustomInboundDocument, Error<GetCustomInboundDocumentResourceError>> {
    ...
    let local_var_uri_str = format!("{}/api/warehouse/documentdeliveries/custom/inbound-v1/{type}/{id}", local_var_configuration.base_path, type=crate::apis::urlencode(r#type), id=crate::apis::urlencode(id));
...
pub async fn release_custom_inbound_document_resource(
    ...
    let local_var_uri_str = format!("{}/api/warehouse/documentdeliveries/custom/inbound-v1/{type}/{id}/release", local_var_configuration.base_path, type=crate::apis::urlencode(r#type), id=crate::apis::urlencode(id));
    let mut local_var_req_builder =
...
) -> Result<crate::models::CustomInboundDocument, Error<SaveCustomInboundDocumentResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn void_document_custom_inbound_document_resource(
    ...
    let local_var_uri_str = format!("{}/api/warehouse/documentdeliveries/custom/inbound-v1/{type}/{id}/void", local_var_configuration.base_path, type=crate::apis::urlencode(r#type), id=crate::apis::urlencode(id));
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
