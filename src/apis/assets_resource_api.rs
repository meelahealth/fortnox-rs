...
pub struct ChangeManualObValueParams {
    ...
    /// asset
    pub asset: Option<crate::models::ManualObAsset>,
}
...
pub struct CreateAssetsResourceParams {
    /// asset
    pub asset: Option<crate::models::CreateAssetWrap>,
}
...
pub struct DeleteAssetsResourceParams {
    ...
    pub given_number: String,
    /// request
    pub request: Option<crate::models::DeleteWrap>,
}
...
pub struct DepreciateParams {
    /// body
    pub body: Option<crate::models::DepreciationWrap>,
}
...
pub struct ScrapParams {
    ...
    pub given_number: String,
    /// asset
    pub asset: Option<crate::models::ScrapWrap>,
}
...
pub struct SellParams {
    ...
    pub given_number: String,
    /// asset
    pub asset: Option<crate::models::SellWrap>,
}
...
pub struct WriteDownParams {
    ...
    pub given_number: String,
    /// asset
    pub asset: Option<crate::models::WriteDownWrap>,
}
...
pub struct WriteUpParams {
    ...
    pub given_number: String,
    /// asset
    pub asset: Option<crate::models::WriteUpWrap>,
}
...
pub async fn change_manual_ob_value(
...
) -> Result<crate::models::AssetSingle, Error<ChangeManualObValueError>> {
    ...
    let local_var_uri_str = format!(
        ...
        GivenNumber = crate::apis::urlencode(given_number)
    );
...
) -> Result<crate::models::AssetSingle, Error<CreateAssetsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::DepreciationResponseWrap, Error<DepreciateError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::AssetSingle, Error<GetAssetsResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_deprecation_list(
...
) -> Result<crate::models::ListAssetWrap, Error<GetDeprecationListError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        ToDate = crate::apis::urlencode(to_date)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn list_assets_resource(
    configuration: &configuration::Configuration,
) -> Result<crate::models::ListAssetWrap, Error<ListAssetsResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn scrap(
    configuration: &configuration::Configuration,
    params: ScrapParams,
) -> Result<crate::models::AssetSingle, Error<ScrapError>> {
    let local_var_configuration = configuration;
...
pub async fn sell(
    configuration: &configuration::Configuration,
    params: SellParams,
) -> Result<crate::models::AssetSingle, Error<SellError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::AssetSingle, Error<WriteDownError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::AssetSingle, Error<WriteUpError>> {
    let local_var_configuration = configuration;
