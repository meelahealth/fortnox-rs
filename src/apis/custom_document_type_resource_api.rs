...
pub struct CreateCustomDocumentTypeResourceParams {
    ...
    pub custom_document_type: Option<crate::models::CustomDocumentType>,
}
...
pub async fn get_all_custom_document_type_resource(
    configuration: &configuration::Configuration,
) -> Result<Vec<crate::models::CustomDocumentType>, Error<GetAllCustomDocumentTypeResourceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_custom_document_type_resource(
...
) -> Result<crate::models::CustomDocumentType, Error<GetCustomDocumentTypeResourceError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/api/warehouse/documentdeliveries/custom/documenttypes-v1/{type}", local_var_configuration.base_path, type=crate::apis::urlencode(r#type));
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
