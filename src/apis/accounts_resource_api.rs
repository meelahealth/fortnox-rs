...
pub struct CreateAccountsResourceParams {
    ...
    /// account to create
    pub account_payload: Option<crate::models::AccountPayloadWrap>,
}
...
) -> Result<crate::models::AccountSingleItemWrap, Error<CreateAccountsResourceError>> {
...
) -> Result<crate::models::AccountSingleItemWrap, Error<GetAccountsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::AccountListItemWrap, Error<ListAccountsResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::AccountSingleItemWrap, Error<UpdateAccountsResourceError>> {
    let local_var_configuration = configuration;
