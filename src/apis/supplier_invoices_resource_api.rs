...
pub struct CreateSupplierInvoicesResourceParams {
    ...
    pub supplier_invoice: Option<crate::models::SupplierInvoiceWrap>,
}
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<ApprovalbookkeepError>> {
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<ApprovalpaymentError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<BookkeepSupplierInvoicesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<CancelSupplierInvoicesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<CreateSupplierInvoicesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<CreditSupplierInvoicesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<GetSupplierInvoicesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SupplierInvoiceListItemWrap, Error<ListSupplierInvoicesResourceError>> {
    let local_var_configuration = configuration;
...
) -> Result<crate::models::SupplierInvoiceWrap, Error<UpdateSupplierInvoicesResourceError>> {
    let local_var_configuration = configuration;
